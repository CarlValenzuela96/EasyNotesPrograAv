 ...
 * @author Carlos
 */
@WebServlet(name = "AgregarRamo", urlPatterns = {"/AgregarRamo"})
public class AgregarRamo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            System.out.println(codRamo);
            System.out.println(tipoRamo);
            System.out.println(pondNT);
            System.out.println(pondNP);
            System.out.println(cantNT);
            System.out.println(cantNP);
            System.out.println(horasSem);
