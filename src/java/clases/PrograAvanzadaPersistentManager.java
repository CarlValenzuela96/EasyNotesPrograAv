...
public class PrograAvanzadaPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "PrograAvanzada";
	...
	private PrograAvanzadaPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new PrograAvanzadaPersistentManager();
		}
