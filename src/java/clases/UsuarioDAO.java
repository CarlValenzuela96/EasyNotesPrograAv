...
public class UsuarioDAO {
	...
	public static Usuario loadUsuarioByORMID(PersistentSession session, int idUsuario) throws PersistentException {
		try {
			return (Usuario) session.load(clases.Usuario.class, new Integer(idUsuario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario getUsuarioByORMID(PersistentSession session, int idUsuario) throws PersistentException {
		try {
			return (Usuario) session.get(clases.Usuario.class, new Integer(idUsuario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario loadUsuarioByORMID(PersistentSession session, int idUsuario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Usuario) session.load(clases.Usuario.class, new Integer(idUsuario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario getUsuarioByORMID(PersistentSession session, int idUsuario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Usuario) session.get(clases.Usuario.class, new Integer(idUsuario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryUsuario(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From clases.Usuario as Usuario");
		if (condition != null)
	...
	public static Usuario createUsuario() {
		return new clases.Usuario();
	}
	
	public static boolean save(clases.Usuario usuario) throws PersistentException {
		try {
			clases.PrograAvanzadaPersistentManager.instance().saveObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(clases.Usuario usuario) throws PersistentException {
		try {
			clases.PrograAvanzadaPersistentManager.instance().deleteObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(clases.Usuario usuario)throws PersistentException {
		try {
			if (usuario.getLoginusuario() != null) {
				usuario.getLoginusuario().setUsuario(null);
			}
			
			if (usuario.getCarreraidCarrera() != null) {
				usuario.getCarreraidCarrera().usuario.remove(usuario);
			}
			
			clases.Semestre[] lSemestres = usuario.semestre.toArray();
			for(int i = 0; i < lSemestres.length; i++) {
				lSemestres[i].setUsuarioidUsuario(null);
			}
	...
	public static boolean deleteAndDissociate(clases.Usuario usuario, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (usuario.getLoginusuario() != null) {
				usuario.getLoginusuario().setUsuario(null);
			}
	...
	public static boolean refresh(clases.Usuario usuario) throws PersistentException {
		try {
			clases.PrograAvanzadaPersistentManager.instance().getSession().refresh(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(clases.Usuario usuario) throws PersistentException {
		try {
			clases.PrograAvanzadaPersistentManager.instance().getSession().evict(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
