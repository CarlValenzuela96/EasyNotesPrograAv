...
public class UsuarioDAO {
	...
	public static boolean save(clases.Usuario usuario) throws PersistentException {
		try {
			PrograAvanzadaPersistentManager.instance().saveObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(clases.Usuario usuario) throws PersistentException {
		try {
			PrograAvanzadaPersistentManager.instance().deleteObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(clases.Usuario usuario)throws PersistentException {
		try {
			if (usuario.getLoginidLogin() != null) {
				usuario.getLoginidLogin().setUsuario(null);
			}
			...
			if (usuario.getCarrera() != null) {
				usuario.getCarrera().setUsuarioidUsuario(null);
			}
	...
	public static boolean refresh(clases.Usuario usuario) throws PersistentException {
		try {
			PrograAvanzadaPersistentManager.instance().getSession().refresh(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(clases.Usuario usuario) throws PersistentException {
		try {
			PrograAvanzadaPersistentManager.instance().getSession().evict(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
